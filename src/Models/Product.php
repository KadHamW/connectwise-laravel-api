...
class Product
{
    ...
    public function __construct(int $catalog_cwid, string $customer_desc, int $quantity, float $price, float $cost, int $opp_cwid, int $locationID, int $businessUnitId, int $product_cwid = 0, int $sequenceNumber = 1)
    {
